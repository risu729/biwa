...
- *(deps)* Update rust crate russh-sftp to v3 ([#1188](https://github.com/risu729/biwa/pull/1188)) - ([a87db61](https://github.com/risu729/biwa/commit/a87db61161709adec7f2371b1ee25747168b5991))
- *(deps)* Update rust crate dirs to v7 ([#1176](https://github.com/risu729/biwa/pull/1176)) - ([6b287d7](https://github.com/risu729/biwa/commit/6b287d7961dd22695dfbfee3b16b4295b5a3fc17))
- *(deps)* Update rust crate usage_rs to v6.11.1 ([#1263](https://github.com/risu729/biwa/pull/1263)) - ([33b15e5](https://github.com/risu729/biwa/commit/33b15e50062057c89d8640a9f726e1ae5708b847))
- *(deps)* Update rust crate usage_rs to v6.11.0 ([#1260](https://github.com/risu729/biwa/pull/1260)) - ([6876f3a](https://github.com/risu729/biwa/commit/6876f3ab3345d9b013071cbf59a66d5205a74610))
- *(deps)* Update rust crate usage_rs to v6.10.0 ([#1248](https://github.com/risu729/biwa/pull/1248)) - ([7e47cca](https://github.com/risu729/biwa/commit/7e47cca84290945b447cf22cd189e7f8d9df91eb))
- *(deps)* Update rust crate usage_rs to v6.9.1 ([#1223](https://github.com/risu729/biwa/pull/1223)) - ([edcd145](https://github.com/risu729/biwa/commit/edcd14568e03100a8563d5acfade42723b57804a))
- *(deps)* Update rust crate usage_rs to v6.9.0 ([#1217](https://github.com/risu729/biwa/pull/1217)) - ([e0a7b42](https://github.com/risu729/biwa/commit/e0a7b42fd4aaad5d5131a02d8252789a59e1ecb5))
- *(deps)* Update rust crate toml to v1.1.6 ([#1207](https://github.com/risu729/biwa/pull/1207)) - ([196f52e](https://github.com/risu729/biwa/commit/196f52e56fd8a76fa4e3fe75f86c2508ffa702d4))
- *(deps)* Update rust crate console to v0.16.6 ([#1199](https://github.com/risu729/biwa/pull/1199)) - ([8a0f803](https://github.com/risu729/biwa/commit/8a0f80302e2f4b5551ff791ba70eea1d030e0661))
- *(deps)* Update rust crate russh to v0.63.3 ([#1195](https://github.com/risu729/biwa/pull/1195)) - ([25ca0a8](https://github.com/risu729/biwa/commit/25ca0a8754c123b7b3a8df900b0ecd04fda4b911))
- *(deps)* Update rust crate usage_rs to v6.8.0 ([#1181](https://github.com/risu729/biwa/pull/1181)) - ([b74729c](https://github.com/risu729/biwa/commit/b74729c090f465e99b86c2152bed48f5a8eb8a87))
...
- *(deps)* Update usage to v6.8.0 ([#1180](https://github.com/risu729/biwa/pull/1180)) - ([3c05ed7](https://github.com/risu729/biwa/commit/3c05ed7bba6fc63a4d4e8ccd65aff87831d668f9))
- *(deps)* Lock file maintenance ([#1256](https://github.com/risu729/biwa/pull/1256)) - ([cb5eee0](https://github.com/risu729/biwa/commit/cb5eee0347cf02b73cf9a2c7329fb17325a169fe))
- *(deps)* Lock file maintenance ([#1220](https://github.com/risu729/biwa/pull/1220)) - ([6984482](https://github.com/risu729/biwa/commit/69844823a53f2b5802e69077e97bb8fceeb2dbd4))
- *(deps)* Lock file maintenance ([#1183](https://github.com/risu729/biwa/pull/1183)) - ([18cec80](https://github.com/risu729/biwa/commit/18cec805c6a701f2ede63e8857acbaa117e3a642))
- *(deps)* Update rust crate rstest to v0.27.0 ([#1179](https://github.com/risu729/biwa/pull/1179)) - ([5f8b748](https://github.com/risu729/biwa/commit/5f8b74841aed9010e3c94d1dc3a465885e68d37c))
...
- *(sync)* Add explicit pull workflows ([#634](https://github.com/risu729/biwa/pull/634)) - ([ebf94b7](https://github.com/risu729/biwa/commit/ebf94b754accf032b1d6c508f951ad25fad8bfbe))
- Add direct command activation ([#632](https://github.com/risu729/biwa/pull/632)) - ([5e5a506](https://github.com/risu729/biwa/commit/5e5a5062967678fd21968579a1ade2d08758dc82))
...
- *(deps)* Update rust crate russh to v0.62.4 ([#915](https://github.com/risu729/biwa/pull/915)) - ([fba2df3](https://github.com/risu729/biwa/commit/fba2df3c023995927dbd318b406af4170cb61320))
- *(deps)* Update rust crate tokio-stream to v0.1.19 ([#912](https://github.com/risu729/biwa/pull/912)) - ([08e90ba](https://github.com/risu729/biwa/commit/08e90ba11facdfbbc430074b4ed4b879aac59dc3))
- *(deps)* Update rust crate clap to v4.6.4 ([#909](https://github.com/risu729/biwa/pull/909)) - ([b10a78e](https://github.com/risu729/biwa/commit/b10a78e766df3e3667d9f613523636046360f33b))
- *(deps)* Update rust crate usage-lib to v3.5.6 ([#902](https://github.com/risu729/biwa/pull/902)) - ([8e3a92d](https://github.com/risu729/biwa/commit/8e3a92d7275c94660e8e325f1945f74214c54a11))
- *(deps)* Update rust crate tokio-util to v0.7.19 ([#901](https://github.com/risu729/biwa/pull/901)) - ([4a3e099](https://github.com/risu729/biwa/commit/4a3e099bea6e8bd7c3fa04facbf8417573024cf1))
- *(deps)* Update rust crate tokio to v1.53.1 ([#893](https://github.com/risu729/biwa/pull/893)) - ([57ce64a](https://github.com/risu729/biwa/commit/57ce64a339716c7501b0cca80e3aadf480cc6224))
- *(deps)* Update rust crate serde_json to v1.0.151 ([#892](https://github.com/risu729/biwa/pull/892)) - ([f927a36](https://github.com/risu729/biwa/commit/f927a36c5bb508ce4bf08a276995625ff93fc4dd))
- *(deps)* Update rust crate russh to v0.62.3 ([#891](https://github.com/risu729/biwa/pull/891)) - ([368bd7f](https://github.com/risu729/biwa/commit/368bd7fc428607939d6d26ab9c9a6a6637995ae2))
- *(deps)* Update rust crate clap to v4.6.3 ([#889](https://github.com/risu729/biwa/pull/889)) - ([e2d4eab](https://github.com/risu729/biwa/commit/e2d4eabcd458fcbc7a63b47c7f2aba45a9ad2a86))
- *(deps)* Update rust crate ignore to v0.4.31 ([#890](https://github.com/risu729/biwa/pull/890)) - ([aa46a0d](https://github.com/risu729/biwa/commit/aa46a0d2cf1f3bbf5adbcbc8a3f19f259f6735d4))
- *(deps)* Update rust crate serde to v1.0.229 ([#883](https://github.com/risu729/biwa/pull/883)) - ([a39baf7](https://github.com/risu729/biwa/commit/a39baf7d79b7c9101ef0b007d16325fcbbdfe263))
- *(deps)* Update rust crate ignore to v0.4.30 ([#877](https://github.com/risu729/biwa/pull/877)) - ([c178aa6](https://github.com/risu729/biwa/commit/c178aa6c1f740f839bbc03be325f9ca5a063ece1))
- *(deps)* Update rust crate tokio to v1.53.0 ([#874](https://github.com/risu729/biwa/pull/874)) - ([c54e013](https://github.com/risu729/biwa/commit/c54e013839b52eb7b4546bf36060b7e889f82452))
